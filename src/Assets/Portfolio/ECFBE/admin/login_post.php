...
if (isset($_POST['mail']) && isset($_POST['mdp'])) {
    ...
    $requete ="SELECT id_login FROM tb_login WHERE mail=? AND mdp=? AND cat='administrateur' GROUP BY 'prenom'";
...
<body>
    ...
    <?php
    if (isset($authOK)) {
        echo "<p>Vous avez été reconnu(e) en tant qu'administrateur " . escape($mail) ." </p>";
